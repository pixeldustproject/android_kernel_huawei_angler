...
EXTRA_OPTS	= -fmodulo-sched -fmodulo-sched-allow-regmoves -g0 -ftree-loop-vectorize \
			...
			-fsingle-precision-constant -fpredictive-commoning -mlow-precision-recip-sqrt \
			-mpc-relative-literal-loads

CORTEX_OPTS	= -march=armv8-a+crc -mcpu=cortex-a57+crypto -mtune=cortex-a57.cortex-a53
...
KBUILD_CFLAGS   := -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -Werror-implicit-function-declaration \
                   -Wno-format-security -Wno-error=misleading-indentation -fmodulo-sched -Wno-bool-compare -Wno-memset-transposed-args -Wno-unused-const-variable \
